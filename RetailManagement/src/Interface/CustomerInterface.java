...
public class CustomerInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("* You are not allowed to change your name.");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(TextFieldProfileEmail, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        AddOrderButton.setFont(new java.awt.Font("Tekton Pro", 0, 18)); // NOI18N
        AddOrderButton.setText("Enter");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, OrderLayout.createSequentialGroup()
                        ...
                        .addGroup(OrderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, OrderLayout.createSequentialGroup()
                                ...
                                .addGap(239, 239, 239))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, OrderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(OrderLayout.createSequentialGroup()
                                    .addGroup(OrderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(OrderLayout.createSequentialGroup()
                                            .addComponent(jLabelUnits)
                                            .addGap(31, 31, 31)
                                            .addComponent(jTextFieldUnitsProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGap(37, 37, 37)
                                    ...
                                    .addGroup(OrderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(jLabelName, javax.swing.GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE)
                                    ...
                                    .addGroup(OrderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(AddOrderButton, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(Order, javax.swing.GroupLayout.PREFERRED_SIZE, 523, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jScrollPaneSearchView, javax.swing.GroupLayout.DEFAULT_SIZE, 610, Short.MAX_VALUE)
                        .addContainerGap())
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jScrollPaneSearchView, javax.swing.GroupLayout.DEFAULT_SIZE, 318, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jButtonSearchOrder, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(Tab, javax.swing.GroupLayout.PREFERRED_SIZE, 659, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void LabelLogOutMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LabelLogOutMouseClicked
        ...
        this.dispose(); 
        LoginInterface loginInt = new LoginInterface();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        String userName = TextFieldProfileName.getText();
        user.setUsername(userName);
        
        user = new User(model,ShoppingjTable, "OrderList.txt");
        
        order = new Order(jTextFieldInvoice.getText());
        user.deleteOrderItem(orderId,userName);
    ...
    private void jButtonCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCheckOutActionPerformed
        ...
        try{
            ...
            fw.write(TextFieldProfileName.getText() + "/" + jTextFieldInvoice.getText() + "/" + jLabelTotalOutput.getText() +"\n");
            fw.close();
        }catch(IOException e){
    ...
    private void jButtonSearchOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchOrderActionPerformed
        model = (DefaultTableModel)jTableViewOrder.getModel();
        //Clear data in JTable
        model.getDataVector().removeAllElements();
        model.fireTableDataChanged();
        
        user = new User(model,jTableViewOrder,"OrderList.txt");
        user.search(this.jTextFieldSearchOrder.getText());
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        if(!(name.equals(TextFieldProfileName.getText()))){
            user.edit(name, TextFieldProfileName.getText());
            TextFieldProfileName.setText(TextFieldProfileName.getText());
        }
        
        if(!(TextFieldProfilePhoneNum.getText().equals(TextFieldProfilePhoneNum.getText()))){
            user.edit(TextFieldProfilePhoneNum.getText(),TextFieldProfilePhoneNum.getText());
            TextFieldProfilePhoneNum.setText(TextFieldProfilePhoneNum.getText());
        }
        
        if(!(TextFieldProfileEmail.getText().equals(TextFieldProfileEmail.getText()))){
            user.edit(TextFieldProfileEmail.getText(),TextFieldProfileEmail.getText());
            TextFieldProfileEmail.setText(TextFieldProfileEmail.getText());
        }
        
        if(!(TextFieldProfileAddress.getText().equals(TextFieldProfileAddress.getText()))){
            user.edit(TextFieldProfileAddress.getText(),TextFieldProfileAddress.getText());
            TextFieldProfileAddress.setText(TextFieldProfileName.getText());
        }
...
//        interUpdate.setLocationRelativeTo(null);
    ...
    private void AddOrderButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddOrderButtonActionPerformed
        ...
        String id = jLabelProductId.getText();
...
//        product = new Product(id, name, type, pPrice, amount, orderId);
//        
//        product.setProductId(id);
//        product.setProductName(name);        
//        product.setProductType(type);
//        oItem.setTotalprice(pPrice);        
//        oItem.setOrderItemQuantity(amount);
//        oItem.setOrderId(orderId);
        
        String userName = TextFieldProfileName.getText();
        
        oItem = new OrderItem("OrderList.txt", orderId, model, ShoppingjTable);
        oItem.addOrderItem(id, name, type, pPrice, amount, userName, QuantityAmountLabel);
